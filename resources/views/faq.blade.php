            ...
            <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#faqAccordion">
                    <div class="accordion-body">
                        PM2.5 refers to particulate matter that is less than 2.5 micrometers in diameter. These particles are small enough to penetrate deep into the lungs and even enter the bloodstream, potentially causing serious health problems.
                    </div>
                </div>
            </div>
            <div class="accordion-item">
