...
// 43.43 Node1
// #define _R0 75.07	// uncomment to define hardcoded R0 value
// 43.43 Node2
// #define _R0 19.96	// uncomment to define hardcoded R0 value
// 43.43 Node3
#define _R0 56.93	// uncomment to define hardcoded R0 value
...
public:
	...
	float readPpm(float voltageInput);
	float readRs(float voltageInput);
	float readRsRL(float voltageInput);	// Rs / RL
	void calibrate(float voltageInput);
